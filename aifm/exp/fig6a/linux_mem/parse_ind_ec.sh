...
echo -e "load (mops),50% tail lat(cycles),90% tail lat (cycles),50% tail encr lat (cycles),90% tail encr lat (cycles),50% tail cmpr lat (cycles),90% tail cmpr lat (cycles)" > summary
